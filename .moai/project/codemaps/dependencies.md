...
| `radix-ui/*` | 10+ 패키지 | Headless UI 컴포넌트 |
...
src/index.js
  └── src/App.jsx
        ...
        │     └── src/pages/* (37개+ 페이지, 모두 lazy 로드)
        │         ├── pages/ProductDetail/index.jsx
        │         ├── pages/ProductDetail/ProductSummary.jsx
...
src/utils/api.js
  ...
  └── @shopby/react-components (useAuthStateContext via hooks)
...
| `components/ui/` | 컴포넌트 디렉토리 | Admin pages, general pages |
